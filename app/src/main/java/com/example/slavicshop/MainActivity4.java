...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameProduct = "Звезда Лады 12000р";
        ...
        InsertData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.getText().toString().isEmpty() || phone.getText().toString().isEmpty()) {
                    Toast.makeText(MainActivity4.this, "Все поля должны быть заполнены", Toast.LENGTH_SHORT).show();
                }else {
                    insertOrders();
                    openActivity();
                }
    ...
    private void insertOrders() {
        ...
        Toast.makeText(MainActivity4.this, "Заказ отправлен", Toast.LENGTH_SHORT).show();
